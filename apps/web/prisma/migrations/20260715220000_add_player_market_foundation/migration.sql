...
CREATE TABLE "PlayerMarketListing" (
    ...
    CONSTRAINT "PlayerMarketListing_sellerId_fkey" FOREIGN KEY ("sellerId") REFERENCES "Player" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "PlayerMarketListing_buyerId_fkey" FOREIGN KEY ("buyerId") REFERENCES "Player" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "PlayerMarketListing_rootItemId_fkey" FOREIGN KEY ("rootItemId") REFERENCES "InventoryItem" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "PlayerMarketEscrowItem" (
    ...
    PRIMARY KEY ("listingId", "inventoryItemId"),
    CONSTRAINT "PlayerMarketEscrowItem_listingId_fkey" FOREIGN KEY ("listingId") REFERENCES "PlayerMarketListing" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "PlayerMarketEscrowItem_inventoryItemId_fkey" FOREIGN KEY ("inventoryItemId") REFERENCES "InventoryItem" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "PlayerMarketMutation" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "PlayerMarketMutation_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "Player" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "PlayerMarketMutation_listingId_fkey" FOREIGN KEY ("listingId") REFERENCES "PlayerMarketListing" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
